...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            echo "Password salah. Silahkan <a href='register.php'>Registrasi</a> jika belum mempunyai akun atau <a href='login.php'>Login</a> kembali.";
        }
    } else {
        // jika email tidak ditemukan
        echo "Email tidak ditemukan. Silahkan <a href='register.php'>Registrasi</a> jika belum mempunyai akun atau <a href='login.php'>Login</a> kembali.";
    }
}